        ...
        for invoice in self.filtered(lambda x: x.type == 'out_invoice'):
            ...
            for line in invoice.invoice_line_ids:
                if line.product_id.email_template_id:
                    ...
                    #Anodoo Modify:原来这里有bug，应该使用email_layout_xmlid作为参数。
                    invoice.message_post_with_template(line.product_id.email_template_id.id, composition_mode='comment', email_layout_xmlid='mail.mail_notification_light')
        return True
